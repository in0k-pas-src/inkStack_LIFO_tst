unit TSTs_inkLIFO_20x3_Enumerate;
...
type
 ...
 tTests_inkLIFO_20x3_Enumerate= class(tTSTCTC_CORE_inkLIFO)
  protected
...
procedure tTests_inkLIFO_20x3_Enumerate._enumData_CLR(const DATA:pointer; str:NativeInt);
begin
    with pTests_EnumDATA(DATA)^ do begin
      owner  :=SELF;
      counter:=0;
...
procedure tTests_inkLIFO_20x3_Enumerate.Enumerate_Nil;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
procedure tTests_inkLIFO_20x3_Enumerate.Enumerate_One;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
procedure tTests_inkLIFO_20x3_Enumerate.Enumerate_Two;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
procedure tTests_inkLIFO_20x3_Enumerate.Enumerate_SiX;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
initialization
    RegisterTest(cTestSuitePath__inkLIFO,tTests_inkLIFO_20x3_Enumerate);
end.
